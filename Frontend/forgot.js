...
function forgot() {
    ...
    axios.post('https://expense-tracker-2o39.onrender.com/password/forgotpassword', { email })
        .then(response => {
...
function reset() {
    ...
    axios.get(`https://expense-tracker-2o39.onrender.com/password/resetpassword/${uuid}`)
        .then(response => {
