...
const forgotPassword = async (req, res) => {
    try {
        ...
        const emailResponse = await tranEmailApi.sendTransacEmail({
            ...
            textContent: `this is your password reset link \n\n"https://expense-tracker-2o39.onrender.com/password/resetpassword/${uniqueId}" \n\nBest regards,\nCoding Team`,
            html:`<a href="https://expense-tracker-2o39.onrender.com/password/resetpassword/${uniqueId}">Reset password</a>`,
        });
